...
- Frontend: `assets/frontend/` — Next.js 14 (App Router), TypeScript
...
- `main.py`: Create app, register routers ONLY (target <500 lines, currently 2280+)
...
### R3. API Conventions
- Prefix: `/api/v1/` for all new endpoints
